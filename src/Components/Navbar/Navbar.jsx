...
const Navbar = ({ selectedProducts }) => {
    return (
        ...
        <div className="navbar flex pl-8 pr-32  justify-around gap-8 items-center bg-white text-black shadow-sm">
            {/* ul menus */}
                ...
                <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                        ...
                        <div className="indicator">
                            ...
                            <span className="badge badge-xs badge-neutral indicator-item">{selectedProducts.length}</span>
                        </div>
                    </div>
                    <div
                        tabIndex={0}
